...
namespace CN.CRM
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            httpClient = CrmContianer.container.GetInstance<IHttpClient>();
            logger = CrmContianer.container.GetInstance<ILogger>();
            fileManager = CrmContianer.container.GetInstance<IFileManager>();
            sessionData = CrmContianer.container.GetInstance<ISessionData>();
