...
namespace CN.UnitTest.MockRepositories
{
    public class NetworkMockRepostiory : INetworkRepository
    {
        ...
        {
            //returns all the calls that a line made this month
            Package package = GetPackageByLineId(lineNumber);
            PackageDetails packDet = GetPackageDetailsByPackageId(package.ID);
